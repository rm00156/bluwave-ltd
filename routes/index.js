...
const { isAdmin, isLoginRequire2faCode, adminRequire2faSetup, setup2fa, twoFa, twoFa2 } = require("../middleware/admin");
...
router.post("/product/:id/save-sale", isAdmin, adminRequire2faSetup, adminDashboardController.saveSale);

router.delete("/product/:productId/sale/:saleId/delete", isAdmin, adminRequire2faSetup, adminDashboardController.deleteSave);
