...
exports.getCreateAdminPage = async function(req, res) {
    ...
    res.render('createAdmin', {user: req.user, companyDetails: companyInfo.getCompanyDetails()});
}
...
exports.getProductPage = async function(req, res) {
    ...
    res.render('adminProduct', {user: req.user, 
                                product: product,
                                productTypes: productTypes,
                                quantities: quantities,
                                optionTypes: optionTypes,
...
exports.getProductTypesPage = async function(req, res) {
    ...
    res.render('adminProductTypes', {user: req.user, 
        productTypes: productTypes,
        companyDetails: companyInfo.getCompanyDetails()})
}
...
exports.getProductTypePage = async function(req, res) {
    ...
    var message = req.session.message;
    req.session.message = undefined;
    res.render('adminProductType', {user: req.user, 
...
exports.getAccountsPage = async function(req, res) {
    ...
    res.render('adminAccounts', {user: req.user,
        accounts: accounts,
        companyDetails: companyInfo.getCompanyDetails()})
}
...
exports.getAccountOrderPage = async function(req, res) {
    ...
    res.render('adminOrder', {user: req.user,
        account: account,
        order: order,
...
exports.getOrdersPage = async function(req, res) {
    ...
    res.render('adminOrders', {user: req.user,
        orders: orders,
        companyDetails: companyInfo.getCompanyDetails()})
}
...
{
    res.render('createAdmin', {errors:errors,
                               formData:req.body,
                               user:req.user,
                               companyDetails: companyInfo.getCompanyDetails()  });
}
